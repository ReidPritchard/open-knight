<template>
  <Teleport to="body">
    <div id="import-modal" class="modal" :class="{ 'modal-open': isOpen }">
      <div class="modal-box">
        ...
        <div v-else>
          ...
          <div class="form-control">
            ...
            <button class="btn btn-primary" @click="importGames">Import</button>

            <button class="btn btn-secondary" @click="importDemoGames">
              Import Demo Games
            </button>
          </div>
        </div>
