...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Tournament::Type).string())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Game::DatePlayed).string().not_null())
        ...
        // Create move time tracking table
        manager
            .create_table(
                Table::create()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_game_tag_game")
                            .from(GameTag::Table, GameTag::GameId)
                            .to(Game::Table, Game::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_game_tag_tag")
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_move_tag_move")
                            .from(MoveTag::Table, MoveTag::MoveId)
                            .to(Move::Table, Move::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_move_tag_tag")
